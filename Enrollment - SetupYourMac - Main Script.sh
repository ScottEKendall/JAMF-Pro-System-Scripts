...
positionListRaw="Engineering,Developer,Management,Sales,Marketing"
...
supportTeamName="Giant Eagle IT Service & Support Portal"
supportTeamPhone="1-888-826-3193, option 1"
supportTeamEmail="SN_Client_Strategies@gianteagle.com"
supportTeamChat="mac_support.teamsonline.gianteagle.com"
...
${supportContactMessage}"
        ...
        touch "/Library/Application Support/GiantEagle/Enrollment/.GiantEagleSetupDone"
        outputLineNumberInVerboseDebugMode
...
function acPowerCheck() {
    ...
    function waitForPower() {
        ...
        osascript -e 'display dialog "Setup Your Mac needs the battery to be at least '"${requiredMinimumBatteryPercentage}"'% to run without AC power.Setup Your Mac waited '"${humanReadablePowerWaitTimer}"' for AC power to be connected, but none was detected.Please connect AC power and try again." with title "Setup Your Mac: No AC power detected" buttons {"OK"} with icon caution'
        exit 1
    ...
    if pmset -g ps | grep "AC Power" > /dev/null ; then
        ...
        if [[ "$acPowerWaitTimer" -gt 0 ]]; then
            osascript -e 'display dialog "Setup Your Mac needs the battery to be at least '"${requiredMinimumBatteryPercentage}"'% to run without AC power.Please plug in your power adapter to continue.Waiting '"${humanReadablePowerWaitTimer}"' (until '"${endTime}"') for AC power before Setup Your Mac quits." with title "Setup Your Mac: No AC power detected" buttons {"OK"} with icon caution' &
            waitForPower
...
# Create `overlayicon` from Self Service's custom icon (thanks, @meschwartz!)
 xxd -p -s 260 "$(defaults read /Library/Preferences/com.jamfsoftware.jamf self_service_plus_path)"/Icon$''/..namedfork/rsrc | xxd -r -p > /var/tmp/overlayicon.icns
            ...
            policyJSON='
            {
                "steps": [
        
                    {
                        ...
                        "subtitle": "Provides authentication into the Giant Eagle network account",
                        "icon": "https://usw2.ics.services.jamfcloud.com/icon/hash_d709eb53f5b0dc98f69b47120df7f8ddd5412f2aaf85ba6b03a10f9eff77e0f7",
                        "progresstext": "Install Jamf Connect",
                        "trigger_list": [
                                         {
                                            "trigger": "jamfconnect",
                                            "validation": "/Library/Application Support/JamfConnect/JCDaemon.app"
                                         }
                        ]
                    },
                    {
                        "listitem": "Cisco Secure Client",
                        "subtitle": "AnyConnect establishes a secure connections between users and corporate networks over the internet.",
                        "icon": "https://usw2.ics.services.jamfcloud.com/icon/hash_e2dc6c0383b3e85be07df58ad5d63944f725e21e8f621a3d15008a8818bc2e67",
                        "progresstext": "Install Cisco Secure Client",
                        "trigger_list": [
                                         {
                                            "trigger": "anyconnect",
                    ...
                    },
                    {
                        ...
                        "subtitle": "Crowdstrike actively scans for threats on your machine without having to manually run virus scans.",
                        "icon": "https://usw2.ics.services.jamfcloud.com/icon/hash_b58a85f6622200a7c3e3da1aa97066937b69200d87884200b700d8ae07d45cb8",
                        "progresstext": "Install CrowdStrike Falcon",
                        "trigger_list": [
                                         {
                                            "trigger": "crowdstrike",
                    ...
                    {
                        "listitem": "Microsoft InTune Company Portal",
                        "subtitle": "Intune simplifies the process of enrolling devices into the management system",
                        "icon": "https://usw2.ics.services.jamfcloud.com/icon/hash_07103bc2866c2f8facb963735fe163ef9f90037c98e4484d8aad8def4c699e46",
                        "progresstext": "Install Microsoft InTune Company Portal",
                        "trigger_list": [
                                         {
                                            "trigger": "intunecompanyportal",
                    ...
                    },
                    {
                        ...
                        "subtitle": "Microsoft 365 empowers your employees to do their best work from anywhere in the world, together in one place.",
                    ...
                    {
                        "listitem": "Install Google Chrome",
                        "subtitle": "Google Chrome is a browser that combines a minimal design with sophisticated technologies to make the Web faster",
                        "icon": "https://usw2.ics.services.jamfcloud.com/icon/hash_d3ada390952159cf2f6a743484f40a3be9b39bf9f7f76299cdabbb05c54f2966",
                        "progresstext": "Install Google Chrome",
                        "trigger_list": [
                                         {
                                            "trigger": "chrome",
                    ...
                    {
                        "listitem": "Customize Settings",
                        "subtitle": "Install printers / Set dock configuration / Network settings / etc",
                        "icon": "https://usw2.ics.services.jamfcloud.com/icon/hash_f0a0c9381bdbac092552f460c1be4f82f8c258720139ef5f5a9382cb9dea4abb",
                        "progresstext": "Set Giant Eagle specific environment settings",
                        "trigger_list": [
                                         {
                                            "trigger": "SetDefaultDock",
                                            "validation": "None"
                                         },
                                         {
                                            "trigger": "configurenetwork",
                                            "validation": "None"
                                         },
                                         {
                                            "trigger": "outset",
                                         ...
                                         {
                                            "trigger": "enrollment_rename",
                                            "validation": "None"
                                         },
                                         {
                                            "trigger": "Mail2Outlook",
                                            "validation": "None"
                                         },
                                         {
                                            "trigger": "install_superman",
                                            "validation": "None"
                                         }
                        ]
                    },
