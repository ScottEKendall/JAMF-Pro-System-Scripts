...
JAMFClientID="ef4cc441-4409-4945-9396-2ba2806cc95b"
JAMFSecret="nkIyONKKDTapOb1plbs_ZGFmhWCxvSKJXY8r4XnE_gadMA_6hyEw7jHIbT-uorCw"
...
function build_superman_parm_string ()
{
    ...
    case "${osInstallType:l}" in
        ...
        "disable" )
            ...
            CommandString=" --reset-super --workflow-disable-update-check --workflow-disable-relaunch"
            ;;
    esac
}
