...
## Addresses the following NIST 800-53 controls:
# * N/A
logmessage "Started processing os_efi_integrity_validated"
rule_arch="i386"
if [[ "$arch" == "$rule_arch" ]] || [[ -z "$rule_arch" ]]; then
    unset result_value
    ...
    exempt=$(/usr/bin/osascript -l JavaScript << EOS 2>/dev/null
ObjC.unwrap($.NSUserDefaults.alloc.initWithSuiteName('com.jamf.compliance_benchmark_6937381ba46939cf086a95f4.audit').objectForKey('os_efi_integrity_validated'))["exempt"]
EOS
)
    exempt_reason=$(/usr/bin/osascript -l JavaScript << EOS 2>/dev/null
ObjC.unwrap($.NSUserDefaults.alloc.initWithSuiteName('com.jamf.compliance_benchmark_6937381ba46939cf086a95f4.audit').objectForKey('os_efi_integrity_validated'))["exempt_reason"]
EOS
)
    customref="$(echo "os_efi_integrity_validated" | rev | cut -d ' ' -f 2- | rev)"
    customref="$(echo "$customref" | tr " " ",")"
    if [[ $result_value == "1" ]]; then
        logmessage "os_efi_integrity_validated passed (Result: $result_value, Expected: \"{'integer': 1}\")"
        /usr/bin/defaults write "$audit_plist" os_efi_integrity_validated -dict-add finding -bool NO
        if [[ ! "$customref" == "os_efi_integrity_validated" ]]; then
            /usr/bin/defaults write "$audit_plist" os_efi_integrity_validated -dict-add reference -string "$customref"
        fi
        /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - os_efi_integrity_validated passed (Result: $result_value, Expected: "{'integer': 1}")"
    else
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            logmessage "os_efi_integrity_validated failed (Result: $result_value, Expected: \"{'integer': 1}\")"
            /usr/bin/defaults write "$audit_plist" os_efi_integrity_validated -dict-add finding -bool YES
            if [[ ! "$customref" == "os_efi_integrity_validated" ]]; then
                /usr/bin/defaults write "$audit_plist" os_efi_integrity_validated -dict-add reference -string "$customref"
            fi
            /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - os_efi_integrity_validated failed (Result: $result_value, Expected: "{'integer': 1}")"
        else
            logmessage "os_efi_integrity_validated failed (Result: $result_value, Expected: \"{'integer': 1}\") - Exemption Allowed (Reason: \"$exempt_reason\")"
            /usr/bin/defaults write "$audit_plist" os_efi_integrity_validated -dict-add finding -bool YES
            if [[ ! "$customref" == "os_efi_integrity_validated" ]]; then
              /usr/bin/defaults write "$audit_plist" os_efi_integrity_validated -dict-add reference -string "$customref"
            fi
            /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - os_efi_integrity_validated failed (Result: $result_value, Expected: "{'integer': 1}") - Exemption Allowed (Reason: "$exempt_reason")"
            /bin/sleep 1
        fi
    fi
    ...
    logmessage "os_efi_integrity_validated does not apply to this architecture"
    /usr/bin/defaults write "$audit_plist" os_efi_integrity_validated -dict-add finding -bool NO
fi
...
## Addresses the following NIST 800-53 controls:
# * CM-7, CM-7(1)
logmessage "Started processing system_settings_cd_dvd_sharing_disable"
rule_arch=""
if [[ "$arch" == "$rule_arch" ]] || [[ -z "$rule_arch" ]]; then
    unset result_value
    ...
    exempt=$(/usr/bin/osascript -l JavaScript << EOS 2>/dev/null
ObjC.unwrap($.NSUserDefaults.alloc.initWithSuiteName('com.jamf.compliance_benchmark_6937381ba46939cf086a95f4.audit').objectForKey('system_settings_cd_dvd_sharing_disable'))["exempt"]
EOS
)
    exempt_reason=$(/usr/bin/osascript -l JavaScript << EOS 2>/dev/null
ObjC.unwrap($.NSUserDefaults.alloc.initWithSuiteName('com.jamf.compliance_benchmark_6937381ba46939cf086a95f4.audit').objectForKey('system_settings_cd_dvd_sharing_disable'))["exempt_reason"]
EOS
)
    ...
    if [[ $result_value == "1" ]]; then
        ...
        /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - system_settings_cd_dvd_sharing_disable passed (Result: $result_value, Expected: "{'integer': 1}")"
    else
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - system_settings_cd_dvd_sharing_disable failed (Result: $result_value, Expected: "{'integer': 1}")"
        else
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - system_settings_cd_dvd_sharing_disable failed (Result: $result_value, Expected: "{'integer': 1}") - Exemption Allowed (Reason: "$exempt_reason")"
            /bin/sleep 1
        fi
    fi
...
## Addresses the following NIST 800-53 controls:
# * N/A
logmessage "Started processing system_settings_siri_listen_disable"
rule_arch=""
if [[ "$arch" == "$rule_arch" ]] || [[ -z "$rule_arch" ]]; then
    unset result_value
...
EOS
    ...
    exempt=$(/usr/bin/osascript -l JavaScript << EOS 2>/dev/null
ObjC.unwrap($.NSUserDefaults.alloc.initWithSuiteName('com.jamf.compliance_benchmark_6937381ba46939cf086a95f4.audit').objectForKey('system_settings_siri_listen_disable'))["exempt"]
EOS
)
    exempt_reason=$(/usr/bin/osascript -l JavaScript << EOS 2>/dev/null
ObjC.unwrap($.NSUserDefaults.alloc.initWithSuiteName('com.jamf.compliance_benchmark_6937381ba46939cf086a95f4.audit').objectForKey('system_settings_siri_listen_disable'))["exempt_reason"]
EOS
)
    ...
    if [[ $result_value == "false" ]]; then
        ...
        /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - system_settings_siri_listen_disable passed (Result: $result_value, Expected: "{'string': 'false'}")"
    else
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - system_settings_siri_listen_disable failed (Result: $result_value, Expected: "{'string': 'false'}")"
        else
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - system_settings_siri_listen_disable failed (Result: $result_value, Expected: "{'string': 'false'}") - Exemption Allowed (Reason: "$exempt_reason")"
            /bin/sleep 1
        fi
    fi
