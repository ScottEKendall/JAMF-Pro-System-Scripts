...
EOS
    ...
    if [[ $result_value == "PASS" ]]; then
        ...
        /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - os_httpd_disable passed (Result: $result_value, Expected: "{'string': 'PASS'}")"
    else
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - os_httpd_disable failed (Result: $result_value, Expected: "{'string': 'PASS'}")"
        else
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - os_httpd_disable failed (Result: $result_value, Expected: "{'string': 'PASS'}") - Exemption Allowed (Reason: "$exempt_reason")"
            /bin/sleep 1
        fi
    fi
...
## Addresses the following NIST 800-53 controls:
# * N/A
logmessage "Started processing os_software_update_app_update_enforce"
rule_arch=""
if [[ "$arch" == "$rule_arch" ]] || [[ -z "$rule_arch" ]]; then
    unset result_value
    result_value=$(/usr/bin/osascript -l JavaScript << EOS
...
EOS
    ...
    exempt=$(/usr/bin/osascript -l JavaScript << EOS 2>/dev/null
ObjC.unwrap($.NSUserDefaults.alloc.initWithSuiteName('com.jamf.compliance_benchmark_6937381ba46939cf086a95f4.audit').objectForKey('os_software_update_app_update_enforce'))["exempt"]
EOS
)
    exempt_reason=$(/usr/bin/osascript -l JavaScript << EOS 2>/dev/null
ObjC.unwrap($.NSUserDefaults.alloc.initWithSuiteName('com.jamf.compliance_benchmark_6937381ba46939cf086a95f4.audit').objectForKey('os_software_update_app_update_enforce'))["exempt_reason"]
EOS
)
    ...
    if [[ $result_value == "true" ]]; then
        ...
        /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - os_software_update_app_update_enforce passed (Result: $result_value, Expected: "{'string': 'true'}")"
    else
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - os_software_update_app_update_enforce failed (Result: $result_value, Expected: "{'string': 'true'}")"
        else
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - os_software_update_app_update_enforce failed (Result: $result_value, Expected: "{'string': 'true'}") - Exemption Allowed (Reason: "$exempt_reason")"
            /bin/sleep 1
        fi
    fi
...
EOS
    ...
    if [[ $result_value == "PASS" ]]; then
        ...
        /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - system_settings_screen_sharing_disable passed (Result: $result_value, Expected: "{'string': 'PASS'}")"
    else
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - system_settings_screen_sharing_disable failed (Result: $result_value, Expected: "{'string': 'PASS'}")"
        else
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - system_settings_screen_sharing_disable failed (Result: $result_value, Expected: "{'string': 'PASS'}") - Exemption Allowed (Reason: "$exempt_reason")"
            /bin/sleep 1
        fi
    fi
...
EOS
    ...
    if [[ $result_value == "PASS" ]]; then
        ...
        /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - system_settings_ssh_disable passed (Result: $result_value, Expected: "{'string': 'PASS'}")"
    else
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - system_settings_ssh_disable failed (Result: $result_value, Expected: "{'string': 'PASS'}")"
        else
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_6937381ba46939cf086a95f4 - system_settings_ssh_disable failed (Result: $result_value, Expected: "{'string': 'PASS'}") - Exemption Allowed (Reason: "$exempt_reason")"
            /bin/sleep 1
        fi
    fi
