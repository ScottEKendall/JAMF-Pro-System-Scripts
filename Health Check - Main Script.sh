...
# Client-side Log
scriptLog="/Library/Application Support/GiantEagle/logs/MacHealthCheck.log"
...
bannerOffset="   "
humanReadableScriptName=$bannerOffset"Mac Health Check"
...
organizationBrandingBannerURL="/Library/Application Support/GiantEagle/SupportFiles/GE_SD_BannerImage.png"
...
organizationDefaultsDomain="com.gianteagle.external"
...
if [[ $( defaults read /Users/$(stat -f %Su /dev/console)/Library/Preferences/.GlobalPreferences.plist AppleInterfaceStyle 2>/dev/null ) == "Dark" ]]; then
    # Dark Mode
    organizationColorScheme="weight=semibold,colour1=#f40036,colour2=#f40036"
else
    # Light Mode
    organizationColorScheme="weight=semibold,colour1=#f40036,colour2=#f40036"
fi
...
[
    ...
    {"title" : "Electron Corner Mask", "subtitle" : "Detects susceptible Electron apps that may cause GPU slowdowns on macOS 26 Tahoe", "icon" : "SF=29.circle,'"${organizationColorScheme}"'", "status" : "pending", "statustext" : "Pending …", "iconalpha" : 0.5},
    {"title" : "Microsoft Teams", "subtitle" : "The hub for teamwork in Microsoft 365.", "icon" : "SF=30.circle,'"${organizationColorScheme}"'", "status" : "pending", "statustext" : "Pending …", "iconalpha" : 0.5},
    {"title" : "zScaler Firewall Protection", "subtitle" : "Cyber security protection to keep you safe while navigating the internet", "icon" : "SF=31.circle,'"${organizationColorScheme}"'", "status" : "pending", "statustext" : "Pending …", "iconalpha" : 0.5},
    {"title" : "Microsoft Office", "subtitle" : "Detemrine if all of the components of the Office Suite are installed", "icon" : "SF=32.circle,'"${organizationColorScheme}"'", "status" : "pending", "statustext" : "Pending …", "iconalpha" : 0.5},
    {"title" : "CrowdStrike Falcon", "subtitle" : "Technology, intelligence, and expertise come together in CrowdStrike Falcon to deliver security that works.", "icon" : "SF=33.circle,'"${organizationColorScheme}"'", "status" : "pending", "statustext" : "Pending …", "iconalpha" : 0.5},
    {"title" : "Microsoft Entra Platform SSO", "subtitle" : "Connection to the Microsoft servers ensuring that you can access your resources", "icon" : "SF=34.circle,'"${organizationColorScheme}"'", "status" : "pending", "statustext" : "Pending …", "iconalpha" : 0.5},
    {"title" : "Printers Installed", "subtitle" : "Make sure that the company wide printers are installed.", "icon" : "SF=35.circle,'"${organizationColorScheme}"'", "status" : "pending", "statustext" : "Pending …", "iconalpha" : 0.5},        
    ...
    if [[ "${operationMode}" != "Test" ]]; then
        ...
        case ${mdmVendor} in
            ...
            "Jamf Pro" )
                ...
                checkElectronCornerMask "28"
                checkInternal "29" "/Applications/Microsoft Teams.app"  "/Applications/Microsoft Teams.app"             "Microsoft Teams"
                checkExternalJamfPro "30" "HealthCheck_zScaler" "/Applications/Zscaler/Zscaler.app"
                checkExternalJamfPro "31" "HealthCheck_Office" "/Applications/Microsoft Outlook.app"
                checkExternalJamfPro "32" "HealthCheck_Falcon" "/Applications/Falcon.app"
                checkExternalJamfPro "33" "HealthCheck_Entra" "/Applications/Company Portal.app"
                checkExternalJamfPro "34" "HealthCheck_Printers" "/System/Applications/Utilities/Print Center.app"
