...
bannerTitle="        $humanReadableScriptName"
...
organizationColorScheme="weight=heavy,colour1=auto,colour=red"
...
organizationSSID="raspberry Giant-Eagle-Guest"
...
jamfProVariables="com.jamf.pro.plist"
...
[[ $(uname -p) == "arm" ]] && computerPlatform="Apple Silicon" || computerPlatform="Intel"
...
supportTeamName="TSD Help Desk"
supportTeamPhone="+1-888-826-3193 (US) / +0008000404315 (Intl) "
...
dialogJSON='
{
    ...
    "message" : "none",
    "iconsize" : "198",
    "infobox" : "**User:** '"{userfullname}"'<br><br>**Computer Model:** '"{computermodel}"'<br><br>**Platform:** '"${computerPlatform}"'<br><br>**Serial Number:** '"{serialnumber}"' ",
    ...
    "listitem" : [
        ...
        {"title" : "zScaler Firewall Protection", "subtitle" : "Cyber security protection to keep you safe while navigating the internet", "icon" : "SF=21.circle,'"${organizationColorScheme}"'", "status" : "pending", "statustext" : "Pending …"},
        {"title" : "Microsoft Office", "subtitle" : "Detemrine if all of the components of the Office Suite are installed", "icon" : "SF=22.circle,'"${organizationColorScheme}"'", "status" : "pending", "statustext" : "Pending …"},
        ...
        {"title" : "Microsoft Entra Platform SSO", "subtitle" : "Connection to the Microsoft servers ensuring that you can access your resources", "icon" : "SF=24.circle,'"${organizationColorScheme}"'", "status" : "pending", "statustext" : "Pending …"},
        {"title" : "Printers Installed", "subtitle" : "Make sure that the company wide printers are installed.", "icon" : "SF=25.circle,'"${organizationColorScheme}"'", "status" : "pending", "statustext" : "Pending …"},        
        {"title" : "Network Quality Test", "subtitle" : "Various networking-related tests of your Mac’s Internet connection", "icon" : "SF=26.circle,'"${organizationColorScheme}"'", "status" : "pending", "statustext" : "Pending …"},
        {"title" : "Computer Inventory", "subtitle" : "The listing of your Mac’s apps and settings", "icon" : "SF=27.circle,'"${organizationColorScheme}"'", "status" : "pending", "statustext" : "Pending …"}
    ]
}
'
...
if [[ "${operationMode}" != "test" ]]; then
    ...
    checkExternal "20" "HealthCheck_zScaler" "/Applications/Zscaler/Zscaler.app"
    checkExternal "21" "HealthCheck_Office" "/Applications/Microsoft Outlook.app"
    checkExternal "22" "HealthCheck_Falcon" "/Applications/Falcon.app"
    checkExternal "23" "HealthCheck_Entra" "/Applications/Company Portal.app"
    checkExternal "24" "HealthCheck_Printers" "/System/Applications/Utilities/Print Center.app"
