...
daysBeforeDeadlineBlurscreen="2"
...
function updateRequiredVariables() {
    ...
    # Determine which OS we are updating to and grab the appropriate icon
    versionPrefix="${ddmVersionString:0:2}"

    if [[ $versionPrefix == "26" ]]; then
        # Tahoe Icon
        organizationIconURL="https://usw2.ics.services.jamfcloud.com/icon/hash_568c4ee325916fcf903b217d3b7dad179524a8c009713bed3cc66afbc235798f"
    elif [[ $versionPrefix == "15" ]]; then
        # Sequoia Icon
        organizationIconURL="https://usw2.ics.services.jamfcloud.com/icon/hash_246988a9f48b9e792f73614a88e2d0ac25bb9e170fa6c258fc8f05cc6789ce02"
    elif [[ $versionPrefix == "14" ]]; then
        # Sonoma Icon
        organizationIconURL="https://usw2.ics.services.jamfcloud.com/icon/hash_01f5557364d5b99ce9b9d33a9bb675771cd85e3d896ad6c7a31cead6902fc233"
    fi
    ...
    supportKB="KB0015249"
    infobuttonaction="https://gianteagle.service-now.com/ge?sys_kb_id=c2700abe2b2032143208f644ce91bff8&id=kb_article_view&sysparm_rank=1&sysparm_tsqueryId=5b829aba2b6432143208f644ce91bfed"
