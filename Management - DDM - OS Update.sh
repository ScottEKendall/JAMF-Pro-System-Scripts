...
# Client-side Log
scriptLog="/Library/Application Support/GiantEagle/logs/DDM-Update.log"
...
reverseDomainNameNotation="com.gianteagle"

# Organization's Script Name
organizationScriptName="DDM_Update_Notice"

# Organization's Directory (i.e., where your client-side scripts reside)
organizationDirectory="/Library/Application Support/GiantEagle/Scripts"
...
declare -A preferenceConfiguration=(
    # Logging and Timing
    ["scriptLog"]="string|/Library/Application Support/GiantEagle/logs/DDM-Update.log"
    ["daysBeforeDeadlineDisplayReminder"]="numeric|14"
    ["daysBeforeDeadlineBlurscreen"]="numeric|3"
    ["daysBeforeDeadlineHidingButton2"]="numeric|2"
    ["daysOfExcessiveUptimeWarning"]="numeric|30"
    ["meetingDelay"]="numeric|75"
    ["acceptableAssertionApplicationNames"]="string|MSTeams zoom.us Webex"
    ["minimumDiskFreePercentage"]="numeric|10"
    ...
    # Support Team
    ["supportTeamName"]="string|TSD Help Desk"
    ["supportTeamPhone"]="string|+1-888-826-3193 (US) / +0008000404315 (Intl)"
    ["supportTeamEmail"]="string|Technology.ServiceDesk@gianteagle.com"
    ["supportTeamWebsite"]="string|https://gianteagle.service-now.com/ge"
    ["supportKB"]="string|Update macOS on Mac"
    ["infobuttonaction"]="string|https://gianteagle.service-now.com/ge?sys_kb_id=2059f6979399b250eeeb31c19dba1053&id=kb_article_view&sysparm_rank=1&sysparm_tsqueryId=94e15746933d3210eeeb31c19dba10a8"
    ["supportKBURL"]="string|[Update macOS on Mac](https://gianteagle.service-now.com/ge?sys_kb_id=2059f6979399b250eeeb31c19dba1053&id=kb_article_view&sysparm_rank=1&sysparm_tsqueryId=94e15746933d3210eeeb31c19dba10a8)"
